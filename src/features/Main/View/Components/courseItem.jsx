        ...
        <div  className="bg-white  dark:bg-gray-800 rounded-xl overflow-hidden shadow hover:shadow-lg transition group">
            ...
            <div className=" flex  pt-2 pb-2 px-4">
              <div className=' flex-1'>
                ...
                <p onClick={()=>navigate('')} className="text-sm cursor-pointer hover:text-primary-light hover:dark:text-primary-dark hover:underline text-gray-600 dark:text-gray-300">በ{course.ustaz}</p>
              </div>
